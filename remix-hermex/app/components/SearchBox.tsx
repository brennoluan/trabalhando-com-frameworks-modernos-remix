...
export function SearchBox() {
  ...
  return (
    <section
      className="bg-primary-pure py-8 sm:py-10 lg:py-12"
      aria-label="Formulário de busca de veículos"
    >
        ...
        <Form method="get" action="/search" className="flex flex-col gap-4">
          ...
          <div>
            <label
              ...
              className="text-neutral-white font-medium text-body-sm mb-2 block"
            >
              Retirada
            </label>
            <div className="grid grid-cols-1 sm:grid-cols-6 gap-3 sm:gap-4">
              ...
              <div className="sm:col-span-3">
                <div className="relative">
                  <span
                    className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-text"
                    aria-hidden="true"
                  >
              ...
              <div className="sm:col-span-1">
                <div className="relative">
                  ...
                  <span
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-text pointer-events-none"
                    aria-hidden="true"
                  >
